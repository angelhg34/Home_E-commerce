        ...
        <header>
            <nav className="bg-white border-gray-200 px-4 lg:px-6 py-2.5 dark:bg-gray-800">
                <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                    <a href="/homeProduct" className="flex items-center">
                        <img src="https://i.pinimg.com/736x/4c/14/da/4c14da61b59d5bb02d892377b6e140d8.jpg" className="mr-3 h-6 sm:h-9" alt="Flowbite Logo" />
                        <span className="self-center text-xl font-semibold whitespace-nowrap dark:text-white">Home e-commerce</span>
                    </a>
